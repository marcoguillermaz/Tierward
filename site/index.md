...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/marcoguillermaz/Tierward
...
features:
  ...
  - icon: 🪜
    title: Tier by tier
    details: Start at Tier 0 with a Stop hook and nothing else. Upgrade one tier at a time as your team's needs grow. Never pay the overhead of a workflow you don't need.
  - icon: 🔌
    title: MCP-native
    details: Ships an MCP server alongside the CLI. Any MCP-aware client (Claude Desktop, Cursor, VS Code) can read your project's governance state without running the CLI.
---
